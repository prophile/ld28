...
import uk.co.alynn.one.LevelProgression;
...
public class GameModeLive implements GameMode {
    ...
    private final LevelProgression _progression;
    private final ColourScheme _colScheme;

    public GameModeLive(Constants ks, LevelProgression progression,
            ColourScheme scheme) {
        this(ks, progression, scheme, 0);
    }
    ...
    public GameModeLive(Constants ks, LevelProgression progression,
        ...
        _colScheme = scheme;
        _thresholdScore = initialScore
                + ks.getInt("level-advance", 10, "Points to advance level.");
    ...
    private GameMode runOneTick(WorldUpdater up) {
        ...
        if (gameOverCounter == -1) {
            try {
                ...
                return new GameModeLive(_constants, _progression,
