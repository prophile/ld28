...
public class BezierIteration {
    ...
    public static void getBezier(List<Vector2> segs, Constants constants) {
        ...
        double [] jellyfish = {226.27417,109.04546,306.91098,91.923267,390.3857,92.212402,472.7514,88.842409,546.76732,85.814047,621.49694,79.512907,694.98495,88.842405,780.54002,99.703848,936.12746,67.761516,945.50278,153.49217,955.19405,242.11198,690.82561,187.06165,707.10679,274.71047,721.44974,351.92498,926.00337,221.95526,941.46217,298.95413,951.42786,348.59232,804.56638,321.18143,808.12204,371.68512,811.35478,417.60211,942.73226,374.44917,937.42156,420.17244,925.20174,525.38088,648.6063,357.99348,622.25397,460.57854,606.90473,520.33049,719.23133,537.31767,771.75654,569.67502,822.01726,600.63737,948.23814,594.56155,929.34034,650.48722,890.35111,765.87093,691.50325,583.87014,569.72604,585.83746,466.45118,587.50587,366.25979,623.05731,266.68027,650.48722,193.99865,670.50791,101.33175,780.67805,52.527932,723.2182,8.0603217,670.86365,103.49702,592.39914,149.50258,541.39074,199.54103,485.9109,355.61935,488.0474,335.37064,416.13183,310.52417,327.88679,87.845945,491.5468,60.609153,404.01,40.041192,337.90627,227.5433,347.96909,226.27417,278.75108,225.06861,212.99955,55.666781,230.76016,64.649763,165.614,72.446638,109.06969,170.43967,120.9012,226.27417,109.04546};

        String selectedName = constants.getString("level", "star",
                "The start level.");
        double[] selected;
        if (selectedName.equals("star")) {
            selected = star;
        } else if (selectedName.equals("infinity")) {
            selected = infinity;
        } else if (selectedName.equals("hourglass")) {
            selected = hourglass;
        } else if (selectedName.equals("bat")) {
            selected = bat;
        } else if (selectedName.equals("first")) {
            selected = first;
        } else if (selectedName.equals("jellyfish")) {
        	selected = jellyfish;
        } else {
